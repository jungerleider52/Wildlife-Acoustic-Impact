# CODE TO CONVERT MULTIPLE TXT FILES INTO ONLY 2 TRANSPOSED ROWS
...
def single_file_process(inputpath):
    ...
    transposed_columns.to_csv(csv_file_path, index=False, header=False, mode='a')
...
def mult_file_process(folder_path):
    ...
    for txt_file in txt_files:
        ...
        print("Now Processing:", txt_file_path)

###############################################################################

# REPLACE THIS WITH THE FOLDER YOU WANT TO RUN THROUGH
mult_file_process('C:\Program Files\Spyder\RocketNoiseDataBase\TestFile')
